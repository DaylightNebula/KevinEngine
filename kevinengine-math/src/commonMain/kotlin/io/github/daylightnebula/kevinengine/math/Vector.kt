...
fun refract(i: Half3, n: Half3, eta: Half): Half3 {
    ...
    return if (k < Half.POSITIVE_ZERO) Half3() else eta * i - (eta * d + sqrt(
        k
    )) * n
}
